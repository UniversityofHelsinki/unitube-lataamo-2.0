...
const NewRecord = () => {
  ...
  const touched = modified && progress.status !== ProgressStatus.NEW_RECORD.PROCESSING && progress.status !== ProgressStatus.PROCESSING_SUBTITLES && progress.status !== ProgressStatus.NEW_RECORD.DONE;
